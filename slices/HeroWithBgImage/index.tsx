...
const HeroWithBgImage: FC<HeroWithBgImageProps> = ({ slice }) => {
  return (
    ...
    >
      ...
      <div
        className="absolute z-10 w-full h-1/ left-1/2 -translate-x-1/2 bottom-0"
        style={{
          background: "linear-gradient(360deg, #1E3B3D 32%, rgba(30, 59, 61, 0) 100%)",
        }}
      ></div>

      <div className="absolute z-20 flex flex-col justify-end items-center text-center inset-x-0 bottom-0 pb-10">
